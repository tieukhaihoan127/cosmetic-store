...
import CategoryChip from "../../../shared/components/ui/Chip/CategoryChip";
import FilterCommonDrawer from "./FilterCommonDrawer";
import useHeadFilter from "../hooks/useHeadFilter";

const HeadFilter = () => {

  const { FILTER_OPTIONS, anchorEl, selectedFilter, open, handleClick, handleClose, handleSelect } = useHeadFilter();
    ...
    <div className="grid grid-cols-12 items-end mt-[35px] [@media(max-width:768px)]:block pb-[20px]">
      ...
      <div className="col-span-4 [@media(max-width:991px)]:col-span-6">
        <div className="flex flex-wrap items-center">
          <CategoryChip categoryName="Bông cotton" />
          <CategoryChip categoryName="Che khuyết điểm" />
          <CategoryChip categoryName="Chì kẻ mắt" />
          <CategoryChip categoryName="Chì kẻ mày" />
          <CategoryChip categoryName="Cọ trang điểm" />
          <CategoryChip categoryName="Dưỡng môi" />
          <CategoryChip categoryName="ELC" />
          <CategoryChip categoryName="Highlighter" />
          <CategoryChip categoryName="Kẻ mắt nước" />
          <CategoryChip categoryName="Kem lót" />
