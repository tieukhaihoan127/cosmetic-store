...
const PreviewProductCard = () => {
    return (
        <Link to={'/products/son-nuoc-bong-thuan-chay-amuse-dew-tint-4g#amuse'}>
            <div className='bg-white rounded-2xl shadow-sm mb-[10px] pb-[20px]'>
            ...
            <div className='absolute top-[10px] left-[10px]'>
                ...
                <div className='border-1 border-black rounded-[38px] px-[20px] py-[8px] text-[14px] font-bold cursor-pointer w-fit mx-auto hover:border-[#BF585B] hover:text-[#BF585B] transition-all duration-300 ease-in-out'>
                    Thêm
                </div>
            </div>
        </Link>
