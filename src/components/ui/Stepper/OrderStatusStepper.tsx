...
// Custom connector (đường kẻ ngang giữa các step)
...
const CustomVerticalConnector = styled(StepConnector)(() => ({
  [`& .${stepConnectorClasses.line}`]: {
    borderLeft: '2px solid #E0E0E0',  // đường kẻ dọc xám
    minHeight: '24px',
    marginLeft: '0px',
  },
  [`&.${stepConnectorClasses.active} .${stepConnectorClasses.line}`]: {
    borderLeftColor: '#AB2328',  // đỏ khi active
  },
  [`&.${stepConnectorClasses.completed} .${stepConnectorClasses.line}`]: {
    borderLeftColor: '#AB2328',  // đỏ khi completed
  },
}))
