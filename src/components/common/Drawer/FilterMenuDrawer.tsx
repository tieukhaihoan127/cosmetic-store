...
import { closeDrawer } from "../../../store/slices/clickFilterFloatingButton";
import FilterAccordion from "../Filter/FilterAccordion";
import FilterAccordionWithSearchBar from "../Filter/FilterAccordionWithSearchBar";
...
const FilterMenuDrawer = () => {
  ...
  const filterMenu = useAppSelector((state) => state.filterFloatingDrawer);
